...
/**
 * print_version - functin that Prints the version of an ELF header.
 * @e_ident: A pointer to array that contains the ELF version.
 */
void print_version(unsigned char *e_ident)
{
printf(" Version: %d",
 ...
 * @e_ident: the pointer to array that contains the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
printf(" OS/ABI: ");
...
/**
 * close_elf - function that closes the ELF file.
